...
_C.OUTPUT_DIR = "/home/jupyter/monocon-pytorch"                               # Output Directory
...
# Data
_C.DATA = CN()
_C.DATA.ROOT = r'/home/jupyter/data/'                  # KITTI Root
...
_C.SOLVER.OPTIM = CN()
_C.SOLVER.OPTIM.LR = 1.5E-03
_C.SOLVER.OPTIM.WEIGHT_DECAY = 1E-04
